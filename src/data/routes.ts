...
export const routesData: RouteData[] = [
  ...
  { origin: 'Eldoret', destination: 'Nairobi', fare: '1500 - 2600', duration: '5–6 hours' },
  { origin: 'Eldoret', destination: 'Kampala', fare: '3000 - 4000', duration: '6–8 hours' },
  ...
  { origin: 'Lamu', destination: 'Mombasa', fare: '2200', duration: '7–9 hours' },
  { origin: 'Lamu', destination: 'Nairobi', fare: '2200', duration: '12–14 hours' },
  ...
  { origin: 'Mombasa', destination: 'Lamu', fare: '2200', duration: '7–9 hours' },
  ...
  { origin: 'Mombasa', destination: 'Mtwapa', fare: '300', duration: '1 hour' },
  { origin: 'Mombasa', destination: 'Mumias', fare: '3400 - 6000', duration: '14–15 hours' },
  { origin: 'Mombasa', destination: 'Nairobi', fare: '1500 - 2500', duration: '8–10 hours' },
  { origin: 'Mtwapa', destination: 'Mombasa', fare: '300', duration: '1 hour' },
  { origin: 'Mtwapa', destination: 'Nairobi', fare: '1800', duration: '9–11 hours' },
  { origin: 'Nairobi', destination: 'Kampala', fare: '2500 - 5000', duration: '11–13 hours' },
  { origin: 'Nairobi', destination: 'Kilifi', fare: '2000 - 2500', duration: '9–10 hours' },
  { origin: 'Nairobi', destination: 'Lamu', fare: '2200', duration: '12–14 hours' },
  { origin: 'Nairobi', destination: 'Malindi', fare: '2000', duration: '10–11 hours' },
  { origin: 'Nairobi', destination: 'Mombasa', fare: '1500 - 2500', duration: '8–10 hours' },
  { origin: 'Nairobi', destination: 'Mtwapa', fare: '1700 - 2000', duration: '9–11 hours' },
