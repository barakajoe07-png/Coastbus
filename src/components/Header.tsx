...
export default function Header() {
  ...
  return (
    <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-white/60 shadow-xs">
      {showBanner && (
        <div className="bg-black text-white text-[11px] font-bold py-2">
          <div className="max-w-md mx-auto px-4 flex justify-between items-center text-center">
      ...
      <header className="max-w-md mx-auto flex justify-between items-center p-4">
